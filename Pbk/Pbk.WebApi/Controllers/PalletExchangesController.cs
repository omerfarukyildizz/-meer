...
using Pbk.Core.Features.PalletExchanges.Get;
...
namespace Pbk.WebApi.Core.Controllers
{
    ...
    public class PalletExchangesController : ApiController
    {
        public PalletExchangesController(IMediator mediator) : base(mediator) { }

        [HttpGet]
        public async Task<IActionResult> GetPalletExchange([FromQuery] ExchangeTypeGetQuery request, CancellationToken cancellationToken)
        {
