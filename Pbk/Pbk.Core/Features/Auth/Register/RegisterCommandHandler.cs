...
using Pbk.Entities.Events.Users;
using Pbk.Entities.Models;

namespace Pbk.Core.Features.Auth.Register;

internal sealed class RegisterCommandHandler : IRequestHandler<RegisterCommand, MediatR.Unit>
{
    ...
    public async Task<MediatR.Unit> Handle(RegisterCommand request, CancellationToken cancellationToken)
    {
