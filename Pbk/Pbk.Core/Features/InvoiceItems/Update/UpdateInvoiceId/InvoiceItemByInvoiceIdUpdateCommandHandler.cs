...
namespace Pbk.Core.Features.InvoiceItems.Update.UpdateInvoiceId
{
    ...
    internal sealed class InvoiceItemByInvoiceIdUpdateCommandHandler : IRequestHandler<InvoiceItemByInvoiceIdUpdateCommand, APIResponse>
    {
        ...
        public InvoiceItemByInvoiceIdUpdateCommandHandler(IUserManager userManager, ITranslate tanslate, IMapper mapper, IInvoiceItemRepository invoiceItemRepository, IUnitOfWork unitOfWork)
        {
            _tanslate = tanslate;
        ...
        public async Task<APIResponse> Handle(InvoiceItemByInvoiceIdUpdateCommand request, CancellationToken cancellationToken)
        {
            try
            {
