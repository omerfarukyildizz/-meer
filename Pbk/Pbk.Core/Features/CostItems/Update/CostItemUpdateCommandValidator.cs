...
namespace Pbk.Core.Features.CostItems.Update
{
    ...
    public sealed class CostItemUpdateCommandValidator : AbstractValidator<CostItemUpdateCommand>
    {
        public CostItemUpdateCommandValidator()
        {
            RuleFor(x => x.CostItemId).GreaterThan(0).WithMessage("Maliyet Kalemi Kimliği sıfırdan büyük olmalıdır.");
